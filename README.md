...
| Section | Topic | Link |
|---|---|---|
| 1.1 | Data Types & Structures | [1.01-data-types/notes.md](python-course-material/1.01-data-types) |
| 1.2 | Comparison Operators | [1.02-comparison-operators/notes.md](python-course-material/1.02-comparison-operators) |
| 1.3 | Python Statements | [1.03-python-statements/notes.md](python-course-material/1.03-python-statements) |
...
2. When you reach section 1.5, read the project write-ups, then open and
   run the actual project code to see it in action.
3. Try modifying the projects once you understand them — that's the best
